...
def change_nickname(request):
    ...
    context = {}
    if request.user.has_nickname():
        context['current_info'] = request.user.get_nickname()
    else:
        context['current_info'] = '暂无昵称'
    context['current_info_title'] = '当前昵称'
...
def change_password(request):
    ...
    if request.method == 'POST':
        form = ForgetPasswordForm(request.POST, user=request.user)
        if form.is_valid():
            user = request.user
