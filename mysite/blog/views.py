...
from read_statistics.utils import read_statisitcs_once_read
...
def get_blog_list_common_data(request, blogs_all_list):
    ...
    context['blog_types'] = BlogType.objects.annotate(blog_count=Count('blog'))  # 添加一个属性值：分类博客数量
...
def blog_detail(request, blog_pk):
    ...
    response.set_cookie(read_cookie_key, 'true', max_age=30)  # 阅读cookie标记
    return response
